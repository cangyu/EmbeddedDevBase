...
void Main_Menu(void)
{
  ...
  BlockNbr = (FlashDestination - 0x08000000) >> 12;//向右移动12位相当于除以4096（4*1k） 计算出页数
  ...
  /* Test if any page of Flash memory where user program will be loaded is write protected */
